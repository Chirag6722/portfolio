...
*   **20-Item Tech Stack Grid**: Interactive hover-responsive skill cards powered by uniform `skillicons.dev` graphics and custom dark-themed `simpleicons.org` fallbacks.
