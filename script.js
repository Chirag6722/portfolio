...
(function () {
  ...
  (function () {
    var IC = {
      ...
      opensource: '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="6" y1="3" x2="6" y2="15"/><circle cx="18" cy="6" r="3"/><circle cx="6" cy="18" r="3"/><path d="M18 9a9 9 0 0 1-9 9"/></svg>',
    ...
    var ITEMS = [
      ...
      { group: 'Portfolio',     label: 'Open Source', type: 'scroll', target: '#open-source', icon: IC.opensource },
      ...
      { group: 'Social Links',  label: 'Resume',     type: 'link',   target: 'https://drive.google.com/file/d/1iE1fIXzTjvoFWlJtOfryhsRFYV7Qov7R/view?usp=sharing', icon: IC.resume },
